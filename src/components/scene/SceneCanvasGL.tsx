...
/**
 * Camada WebGL do canvas global (tier FULL apenas). Carregada via dynamic
 * import por SceneCanvas — assim `three`/`fiber`/`drei` ficam fora do bundle
 * inicial e o mobile nunca baixa esse chunk.
 */
