...
const ITEMS: EcoItem[] = [
  {
    ...
    chips: ["Entrega 16d", "Veloz", "Conversão"],
  },
  {
    id: "mercado",
    layer: 1,
  ...
  },
  {
    ...
    desc: "NF-e e NFC-e emitidas direto da venda — sem digitação, com o contador sempre em cópia.",
    chips: ["NF-e", "Automático", "Contador"],
  },
  {
    id: "ia",
    layer: 3,
  ...
  },
  {
    ...
    chips: ["No ar em 7d", "Veloz"],
  },
  {
    id: "planilha",
    layer: 1,
    label: "Planilha → Sistema",
    title: "Da Planilha ao Sistema",
    desc: "Sua operação sai da planilha para um sistema com login, histórico e zero retrabalho.",
    chips: ["Migração", "Multiusuário", "Histórico"],
  },
  {
    id: "portal",
    layer: 1,
  ...
  },
  {
    ...
    desc: "Abertura, andamento e histórico de cada OS num painel só — o cliente acompanha sozinho.",
    chips: ["OS", "Status", "Histórico"],
  },
  {
    id: "orcamentos",
    layer: 2,
    ...
    desc: "Orçamento profissional gerado em segundos, com aceite online que vira pedido na hora.",
    chips: ["PDF", "Aceite online", "Conversão"],
  },
  {
    id: "rpa",
    layer: 3,
  ...
  },
  {
    id: "guardiao",
    layer: 3,
    label: "Backups & Uptime",
    title: "Backups, Segurança & Uptime",
    desc: "Backup automático, monitoramento e atualizações — sua ferramenta sempre de pé.",
    chips: ["Backup diário", "Monitoramento", "LGPD"],
  },
];
