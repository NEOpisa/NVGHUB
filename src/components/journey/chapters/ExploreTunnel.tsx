...
const PLANETS: PlanetSpec[] = [
  { pos: [-3.4, 0.7, -50.5], r: 0.85, colA: "#2b1a4e", colB: "#8b5cf6", freq: 9, warp: 2.2, spin: 0.1 },
  { pos: [3.6, -0.8, -55.5], r: 1.3, colA: "#1a1030", colB: "#a78bfa", freq: 6, warp: 3.4, spin: 0.06, ring: true },
  { pos: [-3.9, -0.5, -60.2], r: 0.55, colA: "#3b2b63", colB: "#e6e9f6", freq: 14, warp: 4.5, spin: 0.16, moon: true },
  { pos: [3.2, 1.1, -64.3], r: 0.9, colA: "#241640", colB: "#c4b5fd", freq: 7, warp: 1.6, spin: 0.08 },
  // gigante de fundo atrás do portal (backdrop de profundidade)
  { pos: [-1.5, 2.4, -76], r: 3.1, colA: "#150c28", colB: "#6d28d9", freq: 5, warp: 2.8, spin: 0.03 },
];
...
const PLANET_FRAG = /* glsl */ `
  ...
  void main(){
    ...
    col += vec3(0.545, 0.361, 0.965) * rim * (0.35 + uNear * 0.8);
      ...
      new THREE.ShaderMaterial({
        ...
        fragmentShader: /* glsl */ `
          ...
          void main(){
            ...
            gl_FragColor = vec4(vec3(0.545, 0.361, 0.965), f * (0.34 + uNear * 0.5));
          }
        `,
      }),
    [uniforms],
