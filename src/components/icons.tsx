...
export function CheckIcon({ size = 13, strokeWidth = 2.5 }: { size?: number; strokeWidth?: number }) {
  return (
...
export function StoreIcon({ size = 20 }: { size?: number }) {
  return (
    <svg {...strokeProps(size)}>
      <path d="M3 9l1-5h16l1 5M3 9a2 2 0 0 0 4 0 2 2 0 0 0 4 0 2 2 0 0 0 4 0 2 2 0 0 0 4 0M4 9v10a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9M9 21v-5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v5" />
    </svg>
  );
}
